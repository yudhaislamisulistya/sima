...
<div class="content-body">
    <div class="container-fluid">
        <div class="page-titles">
            <h4>Tambah Daftar Arsip</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah Daftar Arsip</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Daftar Arsip</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{route('save_tambah_daftar_arsip')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>File</label>
                                    <input type="file" name="file_lampiran" class="form-control input-rounded">
                                </div>
                                <div class="form-group">
