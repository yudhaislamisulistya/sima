                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{route('save_tambah_surat_masuk')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Nomor Agenda</label>
                                    <input type="text" name="no_agenda" class="form-control input-rounded" placeholder="001/AB/CDE/2020">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_terima" class="form-control input-rounded" placeholder="2021-06-15">
                                </div>
                                <div class="form-group">
                                    <label>Sumber Surat</label>
                                    <input type="text" name="sumber_surat" class="form-control input-rounded" placeholder="...">
                                </div>
                                <div class="form-group">
                                    <label>Perihal</label>
