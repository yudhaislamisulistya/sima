    ...
    <div class="container-fluid">
        <div class="page-titles">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah CV</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah CV</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{route('save_tambah_curicullum_vitae')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Nama Penyetor</label>
                                    <input type="text" name="nama_penyetor" class="form-control input-rounded" placeholder="Apriyadi Aries">
                                </div>
                                <div class="form-group">
