    ...
    <div class="container-fluid">
        <div class="page-titles">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah Jabatan</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{route('save_tambah_jabatan')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Nama Jabatan</label>
                                    <input type="text" name="nama_jabatan" class="form-control input-rounded" placeholder="Direksi">
                                </div>
                                <div class="form-group">
